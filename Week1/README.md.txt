...
Stereotype Annotations – Add annotation to class:
...
Application Context Creation – scans & initializes beans

Auto-Configuration – creates beans based on conditions

External Configuration – loads properties from files/env/CLI

Embedded Web Server – starts server for web apps

Application Startup – runs @PostConstruct methods

Application Ready – app is fully ready 🚀
